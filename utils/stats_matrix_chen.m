...
StatsSorted_T = zeros(15,7,3);
StatsSorted_h = zeros(15,7,3);
...
% Layer 1: Heun's. Unstable for h > 0.02. 
...
StatsSorted_T(:,:,1) = [h     1 NaN NaN NaN NaN NaN;...
                        ...
                        h/2   1 mean(abs(Z_Heuns1_002)) std(Z_Heuns1_002) Q2H_1_002-Q1H_1_002 Q3H_1_002-Q2H_1_002 Q2H_1_002;...
                        h/2   10 mean(abs(Z_Heuns10_002)) std(Z_Heuns10_002) Q2H_10_002-Q1H_10_002 Q3H_10_002-Q2H_10_002 Q2H_10_002;...
                        h/2   50 mean(abs(Z_Heuns50_002)) std(Z_Heuns50_002) Q2H_50_002-Q1H_50_002 Q3H_50_002-Q2H_50_002 Q2H_50_002;...
                        h/2^2 1 mean(abs(Z_Heuns1_001)) std(Z_Heuns1_001) Q2H_1_001-Q1H_1_001 Q3H_1_001-Q2H_1_001 Q2H_1_001;...
                        h/2^2 10 mean(abs(Z_Heuns10_001)) std(Z_Heuns10_001) Q2H_10_001-Q1H_10_001 Q3H_10_001-Q2H_10_001 Q2H_10_001;...
                        h/2^2 50 mean(abs(Z_Heuns50_001)) std(Z_Heuns50_001) Q2H_50_001-Q1H_50_001 Q3H_50_001-Q2H_50_001 Q2H_50_001;...
                        h/2^3 1 mean(abs(Z_Heuns1_0005)) std(Z_Heuns1_0005) Q2H_1_0005-Q1H_1_0005 Q3H_1_0005-Q2H_1_0005 Q2H_1_0005;...
                        h/2^3 10 mean(abs(Z_Heuns10_0005)) std(Z_Heuns10_0005) Q2H_10_0005-Q1H_10_0005 Q3H_10_0005-Q2H_10_0005 Q2H_10_0005;...
                        h/2^3 50 mean(abs(Z_Heuns50_0005)) std(Z_Heuns50_0005) Q2H_50_0005-Q1H_50_0005 Q3H_50_0005-Q2H_50_0005 Q2H_50_0005;...
                        h/2^4 1 mean(abs(Z_Heuns1_00025)) std(Z_Heuns1_00025) Q2H_1_00025-Q1H_1_00025 Q3H_1_00025-Q2H_1_00025 Q2H_1_00025;...
                        h/2^4 10 mean(abs(Z_Heuns10_00025)) std(Z_Heuns10_00025) Q2H_10_00025-Q1H_10_00025 Q3H_10_00025-Q2H_10_00025 Q2H_10_00025;...
                        h/2^4 50 mean(abs(Z_Heuns50_00025)) std(Z_Heuns50_00025) Q2H_50_00025-Q1H_50_00025 Q3H_50_00025-Q2H_50_00025 Q2H_50_00025];

% Layer 2: RK4. Unstable for h > 0.04
StatsSorted_T(:,:,2) = [h     1 mean(abs(Z_RK4s1_004)) std(Z_RK4s1_004) Q2R_1_004-Q1R_1_004 Q3R_1_004-Q2R_1_004 Q2R_1_004;...
                        h     10 mean(abs(Z_RK4s10_004)) std(Z_RK4s10_004) Q2R_10_004-Q1R_10_004 Q3R_10_004-Q2R_10_004 Q2R_10_004;...
                        h     50 mean(abs(Z_RK4s50_004)) std(Z_RK4s50_004) Q2R_50_004-Q1R_50_004 Q3R_50_004-Q2R_50_004 Q2R_50_004;...
                        h/2   1 mean(abs(Z_RK4s1_002)) std(Z_RK4s1_002) Q2R_1_002-Q1R_1_002 Q3R_1_002-Q2R_1_002 Q2R_1_002;...
                        h/2   10 mean(abs(Z_RK4s10_002)) std(Z_RK4s10_002) Q2R_10_002-Q1R_10_002 Q3R_10_002-Q2R_10_002 Q2R_10_002;...
                        h/2   50 mean(abs(Z_RK4s50_002)) std(Z_RK4s50_002) Q2R_50_002-Q1R_50_002 Q3R_50_002-Q2R_50_002 Q2R_50_002;...
                        h/2^2 1 mean(abs(Z_RK4s1_001)) std(Z_RK4s1_001) Q2R_1_001-Q1R_1_001 Q3R_1_001-Q2R_1_001 Q2R_1_001;...
                        h/2^2 10 mean(abs(Z_RK4s10_001)) std(Z_RK4s10_001) Q2R_10_001-Q1R_10_001 Q3R_10_001-Q2R_10_001 Q2R_10_001;...
                        h/2^2 50 mean(abs(Z_RK4s50_001)) std(Z_RK4s50_001) Q2R_50_001-Q1R_50_001 Q3R_50_001-Q2R_50_001 Q2R_50_001;...
                        h/2^3 1 mean(abs(Z_RK4s1_0005)) std(Z_RK4s1_0005) Q2R_1_0005-Q1R_1_0005 Q3R_1_0005-Q2R_1_0005 Q2R_1_0005;...
                        h/2^3 10 mean(abs(Z_RK4s10_0005)) std(Z_RK4s10_0005) Q2R_10_0005-Q1R_10_0005 Q3R_10_0005-Q2R_10_0005 Q2R_10_0005;...
                        h/2^3 50 mean(abs(Z_RK4s50_0005)) std(Z_RK4s50_0005) Q2R_50_0005-Q1R_50_0005 Q3R_50_0005-Q2R_50_0005 Q2R_50_0005;...
                        h/2^4 1 mean(abs(Z_RK4s1_00025)) std(Z_RK4s1_00025) Q2R_1_00025-Q1R_1_00025 Q3R_1_00025-Q2R_1_00025 Q2R_1_00025;...
                        h/2^4 10 mean(abs(Z_RK4s10_00025)) std(Z_RK4s10_00025) Q2R_10_00025-Q1R_10_00025 Q3R_10_00025-Q2R_10_00025 Q2R_10_00025;...
                        h/2^4 50 mean(abs(Z_RK4s50_00025)) std(Z_RK4s50_00025) Q2R_50_00025-Q1R_50_00025 Q3R_50_00025-Q2R_50_00025 Q2R_50_00025];

% Layer 3: GLRK4. Unstable for h > 0.04
StatsSorted_T(:,:,3) = [h     1 mean(abs(Z_GLRK4s1_004)) std(Z_GLRK4s1_004) Q2G_1_004-Q1G_1_004 Q3G_1_004-Q2G_1_004 Q2G_1_004;...
                        h     10 mean(abs(Z_GLRK4s10_004)) std(Z_GLRK4s10_004) Q2G_10_004-Q1G_10_004 Q3G_10_004-Q2G_10_004 Q2G_10_004;...
                        h     50 mean(abs(Z_GLRK4s50_004)) std(Z_GLRK4s50_004) Q2G_50_004-Q1G_50_004 Q3G_50_004-Q2G_50_004 Q2G_50_004;...
                        h/2   1 mean(abs(Z_GLRK4s1_002)) std(Z_GLRK4s1_002) Q2G_1_002-Q1G_1_002 Q3G_1_002-Q2G_1_002 Q2G_1_002;...
                        h/2   10 mean(abs(Z_GLRK4s10_002)) std(Z_GLRK4s10_002) Q2G_10_002-Q1G_10_002 Q3G_10_002-Q2G_10_002 Q2G_10_002;...
                        h/2   50 mean(abs(Z_GLRK4s50_002)) std(Z_GLRK4s50_002) Q2G_50_002-Q1G_50_002 Q3G_50_002-Q2G_50_002 Q2G_50_002;...
                        h/2^2 1 mean(abs(Z_GLRK4s1_001)) std(Z_GLRK4s1_001) Q2G_1_001-Q1G_1_001 Q3G_1_001-Q2G_1_001 Q2G_1_001;...
                        h/2^2 10 mean(abs(Z_GLRK4s10_001)) std(Z_GLRK4s10_001) Q2G_10_001-Q1G_10_001 Q3G_10_001-Q2G_10_001 Q2G_10_001;...
                        h/2^2 50 mean(abs(Z_GLRK4s50_001)) std(Z_GLRK4s50_001) Q2G_50_001-Q1G_50_001 Q3G_50_001-Q2G_50_001 Q2G_50_001;...
                        h/2^3 1 mean(abs(Z_GLRK4s1_0005)) std(Z_GLRK4s1_0005) Q2G_1_0005-Q1G_1_0005 Q3G_1_0005-Q2G_1_0005 Q2G_1_0005;...
                        h/2^3 10 mean(abs(Z_GLRK4s10_0005)) std(Z_GLRK4s10_0005) Q2G_10_0005-Q1G_10_0005 Q3G_10_0005-Q2G_10_0005 Q2G_10_0005;...
                        h/2^3 50 mean(abs(Z_GLRK4s50_0005)) std(Z_GLRK4s50_0005) Q2G_50_0005-Q1G_50_0005 Q3G_50_0005-Q2G_50_0005 Q2G_50_0005;...
                        h/2^4 1 mean(abs(Z_GLRK4s1_00025)) std(Z_GLRK4s1_00025) Q2G_1_00025-Q1G_1_00025 Q3G_1_00025-Q2G_1_00025 Q2G_1_00025;...
                        h/2^4 10 mean(abs(Z_GLRK4s10_00025)) std(Z_GLRK4s10_00025) Q2G_10_00025-Q1G_10_00025 Q3G_10_00025-Q2G_10_00025 Q2G_10_00025;...
                        h/2^4 50 mean(abs(Z_GLRK4s50_00025)) std(Z_GLRK4s50_00025) Q2G_50_00025-Q1G_50_00025 Q3G_50_00025-Q2G_50_00025 Q2G_50_00025];                        
...
% Layer 2: RK4
StatsSorted_h(:,:,2) = [h     1 mean(abs(Z_RK4s1_004)) std(Z_RK4s1_004) Q2R_1_004-Q1R_1_004 Q3R_1_004-Q2R_1_004 Q2R_1_004;...
                        h/2   1 mean(abs(Z_RK4s1_002)) std(Z_RK4s1_002) Q2R_1_002-Q1R_1_002 Q3R_1_002-Q2R_1_002 Q2R_1_002;...
                        h/2^2 1 mean(abs(Z_RK4s1_001)) std(Z_RK4s1_001) Q2R_1_001-Q1R_1_001 Q3R_1_001-Q2R_1_001 Q2R_1_001;...
                        h/2^3 1 mean(abs(Z_RK4s1_0005)) std(Z_RK4s1_0005) Q2R_1_0005-Q1R_1_0005 Q3R_1_0005-Q2R_1_0005 Q2R_1_0005;...
                        h/2^4 1 mean(abs(Z_RK4s1_00025)) std(Z_RK4s1_00025) Q2R_1_00025-Q1R_1_00025 Q3R_1_00025-Q2R_1_00025 Q2R_1_00025;...
...
% Layer 3: GLRK4
StatsSorted_h(:,:,3) = [h     1 mean(abs(Z_GLRK4s1_004)) std(Z_GLRK4s1_004) Q2G_1_004-Q1G_1_004 Q3G_1_004-Q2G_1_004 Q2G_1_004;...
                        h/2   1 mean(abs(Z_GLRK4s1_002)) std(Z_GLRK4s1_002) Q2G_1_002-Q1G_1_002 Q3G_1_002-Q2G_1_002 Q2G_1_002;...
                        h/2^2 1 mean(abs(Z_GLRK4s1_001)) std(Z_GLRK4s1_001) Q2G_1_001-Q1G_1_001 Q3G_1_001-Q2G_1_001 Q2G_1_001;...
                        h/2^3 1 mean(abs(Z_GLRK4s1_0005)) std(Z_GLRK4s1_0005) Q2G_1_0005-Q1G_1_0005 Q3G_1_0005-Q2G_1_0005 Q2G_1_0005;...
                        h/2^4 1 mean(abs(Z_GLRK4s1_00025)) std(Z_GLRK4s1_00025) Q2G_1_00025-Q1G_1_00025 Q3G_1_00025-Q2G_1_00025 Q2G_1_00025;...
