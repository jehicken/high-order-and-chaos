...
for p = 1:size(order,1)
    ...
    for n = 1:size(base_steps,1)
        ...
        # then we have 10 samples for 100, 100 samples for 10 units, and 1000
        # samples for 1 units.
        ...
        for s1 = 1:time_fac 
            for s2 = 1:time_fac
                for s3 = 1:time_fac
                    ...
                    z_avg[ptr,n,2] = calcZAverage(sol, ibeg, iend,
                                                  time_fac*base_steps[n],
                                                  order[p])
                    ...
                    z_avg[ptr,n,3] = calcZAverage(sol, ibeg, iend,
